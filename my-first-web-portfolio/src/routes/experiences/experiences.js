export let jobExperiences = [
    {
        ...
        <p>One of the highlights of my time at Apple was the opportunity to work on the design of user interfaces for digital platforms such as iOS and macOS. This presented a unique set of challenges and opportunities, as I had to balance aesthetic considerations with usability and functionality. I collaborated closely with product designers and engineers to create intuitive and user-friendly interfaces that seamlessly integrated with Apple's hardware products, providing users with an unparalleled experience.</p>
    ...
    },
    {
        ...
        <p>Another highlight of my time at Google was the emphasis on personal and professional growth. Whether it was attending internal workshops on emerging technologies or pursuing advanced certifications in cloud computing, Google provided ample opportunities for continuous learning and development. I found myself constantly challenged to expand my skill set and explore new areas of interest, which ultimately contributed to my growth as an engineer.</p>
    ...
    },
    {
        ...
        desc: `<p>As a Product Manager at Facebook, I had the privilege of being part of a company that is redefining the way people connect and communicate in the digital age. Over the course of five years, I played a key role in shaping the direction of products that are used by billions of people around the world, from Facebook's flagship app to emerging platforms and technologies.</p>
        <p>One of the most exciting aspects of my role was the opportunity to work on cutting-edge products and features that are shaping the future of social media. Whether it was launching new tools for content creators or enhancing privacy and security features, I was constantly challenged to think innovatively and prioritize the needs of Facebook's diverse user base.</p>
        <p>Collaboration was fundamental to the success of our product development efforts at Facebook. I had the privilege of working with cross-functional teams comprising engineers, designers, data scientists, and researchers, each bringing their unique perspectives and expertise to the table. Together, we tackled complex problems and developed solutions that pushed the boundaries of what was possible.</p>
        <p>One of the highlights of my time at Facebook was the opportunity to lead the development of a new messaging platform that revolutionized the way people communicate online. From conceptualization to launch, I worked closely with engineering and design teams to create an intuitive and user-friendly interface that prioritized privacy and personalization. The positive feedback from users was incredibly rewarding and reaffirmed the impact of our work.</p>
    ...
    },
    {
        ...
        desc: `<p>During my six-year tenure as a Software Engineer at Tencent, I had the opportunity to work on some of the most innovative projects in the tech industry. From developing cutting-edge gaming platforms to creating scalable solutions for cloud computing, every day presented new challenges and opportunities to push the boundaries of technology.</p>
