...
<div class="contact-main-container flex flex-col justify-center items-center laptop:min-h-screen pb-12 tablet:py-16 laptop:py-24" class:hide={!$mounted}>
	<div class="contact-page-title-div px-24 pt-12 laptop:py-24">
